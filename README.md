...
1. This was generated in R using the outputs from script 2. The script for this is in the Figures folder
2. This was generated in R using outputs from scripts 2 and 7.
3. Made using script 6
4. Made using QGIS. Interactive map is available by running script 11. 



Supplemental figures

1. Generate in script 2
2. Generated using figure script 2
3. Generate in QGIS
4. Generated in R using figure script S4
5. Generated in figure script S5
